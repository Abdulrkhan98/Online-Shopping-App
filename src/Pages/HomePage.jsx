...
const Homepage = () => {
  ...
  const handleNext = () => setCurrentIndex(prev => (prev === slide.length - 1 ? 0 : prev + 1));
  const handlePrev = () => setCurrentIndex(prev => (prev === 0 ? slide.length - 1 : prev - 1));
  ...
  return (
    <>
        ...
        {slide.length > 0 && (
          <div className="relative w-full md:w-[80%] lg:w-[70%] h-[400px] md:h-[550px] flex items-center justify-center rounded-3xl shadow-2xl overflow-hidden">
            ...
            <div className="w-full h-full flex flex-col items-center justify-center bg-gray-900">
              ...
              />
              <p className="absolute bottom-10 text-white text-lg md:text-4xl font-semibold px-5 py-2 rounded-lg">
      ...
      <section className="flex flex-col items-center justify-center py-10 bg-gray-100">
        <h2 className="text-3xl md:text-5xl font-bold mb-6">SALES UPTO 50%</h2>
       <img
        src={clothes}           
        alt="Sales Banner"
        className="w-full md:w-[80%] lg:w-[70%] rounded-xl shadow-lg"
/>
